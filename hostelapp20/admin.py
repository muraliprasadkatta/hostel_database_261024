...
from .models import CustomUser, AddProperty, Room, Tenant, ChangedPassword, History, Remainder, ManagementPin, OtpValidation, RecentSearch
...
class RoomAdmin(admin.ModelAdmin):
    ...
    def occupied_beds_display(self, obj):
        return obj.property.occupied_beds
...
class OtpValidationAdmin(admin.ModelAdmin):
    list_display = ['email', 'otp', 'token', 'created_at']
    search_fields = ['email', 'otp']
    list_filter = ['created_at']
admin.site.register(OtpValidation, OtpValidationAdmin)

class RecentSearchAdmin(admin.ModelAdmin):
    list_display = ['user', 'property_id', 'search_text', 'timestamp']
    search_fields = ['user__username', 'property_id', 'search_text']
